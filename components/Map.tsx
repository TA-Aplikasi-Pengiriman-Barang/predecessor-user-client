...
import userLoc from "../assets/icon/userLoc.svg";
import ruteMap from "../assets/icon/ruteMap.svg";
import ruteMapBlue from "../assets/icon/ruteMapBlue.svg";
import ruteMapRed from "../assets/icon/ruteMapRed.svg";
import ruteMapMix from "../assets/icon/ruteMapMix.svg";
import busJadwal from "../assets/icon/bus/busJadwal.svg";
import Image from "next/image";
import Draggable from "react-draggable";
import halte from "../assets/icon/detailHalte/halte.svg";
import terkait from "../assets/icon/detailHalte/terkait.svg";
import sekitar from "../assets/icon/detailHalte/sekitar.svg";
import redCrowd from "../assets/icon/crowd/redCrowd.svg";
import location from "../assets/icon/location.svg";
import ruteAll from "../assets/image/ruteAll.svg";
import ruteBiru from "../assets/image/ruteBiru.svg";
import ruteMerah from "../assets/image/ruteMerah.svg";
