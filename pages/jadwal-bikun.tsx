...
import bus from "../static/icon/bus.svg";
...
export default function jadwalbikun() {
  return (
    <Layout>
      <div className="bg-white" id="front">
      ...
      <div className="bg-blue-primary h-16 rounded-[0_0_1rem_1rem] z-10 flex justify-center">
        ...
        <div className="pt-20 px-4 space-y-4">
          ...
          <div>
            <div className="flex space-x-2 w-full pb-2">
              <p className="text-[10px] w-1/2">Rabu, 2 November 2022</p>
              <div className="h-[1px] bg-[#D9D9D9] w-full my-auto"></div>
            </div>
